...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-neutral-200/70 bg-neutral-50/85 backdrop-blur-xl dark:border-neutral-800/70 dark:bg-neutral-900/85">
      <div className="mx-auto max-w-[960px] px-4 py-4 sm:px-6 sm:py-5">
        <div className="flex items-center justify-between">
          {/* Dominio (enlace a landing) */}
          <Link
            to="/"
              className="text-sm font-medium text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200 sm:text-base"
            aria-label="Ir a inicio"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
          >
            <span className="sm:hidden">FLM</span>
            <span className="hidden sm:inline">portfolio-flm.vercel.app</span>
          </Link>
          ...
          <div className="flex items-center space-x-1">
            ...
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-md bg-neutral-50 dark:bg-neutral-900 group-hover:bg-neutral-100 dark:group-hover:bg-neutral-800 flex items-center justify-center">
