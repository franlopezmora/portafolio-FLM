...
None of this would have been possible without the team. I worked alongside **Nicolás Garay**, **Mariano Iturriza** and **Marcos Belli**, and each one took ownership of a different microservice. This allowed us to advance in parallel and then integrate in the gateway. We faced concrete problems: synchronizing database schemas, defining API contracts, handling asynchronous errors and organizing our repository so it was easy to navigate.
